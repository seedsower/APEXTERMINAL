# APex Commodity Changelog

All notable changes to the APex Commodity project will be documented in this file.
...
- Rebranded from Drift Protocol to APex Commodity
